...
<div class="main-header">
    ...
    <p>Tác giả: Hoàng Thị Chung - Trường Tiểu học Ngọc Đường - ĐT: 0356078575</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Thị Chung - Trường Tiểu học Ngọc Đường - ĐT: 0356078575</div>", unsafe_allow_html=True)
